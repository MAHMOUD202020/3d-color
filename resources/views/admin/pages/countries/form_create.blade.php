<form method="post" action="{{route('admin.countries.store')}}" enctype="multipart/form-data">
    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            ...
            <input maxlength="50" name="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar" placeholder="@lang('form.placeholder.country name ar')" value="{{old('name_ar')}}" required>
        ...
        <div class="form-group col-md-6">
            ...
            <input maxlength="50" name="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en" placeholder="@lang('form.placeholder.country name en')" value="{{old('name_en')}}" required>

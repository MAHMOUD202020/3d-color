...
{{--    ///////////////////////// start clone /////////////////////////////--}}
    <div class="cover-kurly clone d-none bg-light pt-3 pb-3 mb-4 row">
        <div class="col-md-5">
            <input maxlength="50" required name="kurly[0][name_ar]" type="text" class="name_ar form-control" placeholder="الاسم باللغة العربية" value="">
        </div>
        <div class="col-md-5">
        ...
        <div class="col-md-5">
            <input maxlength="50" required name="kurly[0][name_en]" type="text" class="name_en form-control" placeholder="الاسم باللغة الانجليزية" value="">
        </div>
        <div class="col-md-5">

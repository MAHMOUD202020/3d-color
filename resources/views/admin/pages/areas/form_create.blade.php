<form method="post" action="{{route('admin.areas.store')}}">
    ...
    <div class="form-row mb-4">
        ...
        <div class="form-group col-md-6">
            ...
            <input maxlength="50" name="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en" placeholder="@lang('form.placeholder.area name ar')" value="{{old('name_en')}}" required>

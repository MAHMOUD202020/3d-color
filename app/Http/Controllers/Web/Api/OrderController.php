...
class OrderController extends Controller
{
    ...
    private function foreachProducts($request)
    {
        ...
        foreach ($products as $product) {
            ...
            $this->priceProductAndUpdateOrderPrice($product);
    ...
    private function priceProductAndUpdateOrderPrice($product){
        ...
        if (count($this->options) > 0) {
            ...
            if ($product->in_sale) {
                ...
                $this->order_price += $optionValueWanted->sale_price > 0 ? $optionValueWanted->sale_price : $optionValueWanted->regular_price;

            } else {

                $this->order_price += $optionValueWanted->regular_price;
            }

            $this->product_regular_price = $optionValueWanted->regular_price;

            $this->product_sale_price = $optionValueWanted->sale_price > 0  &&  $optionValueWanted->sale_price >  $this->product_regular_price ? $optionValueWanted->sale_price : 0;
            ...
            if ($product->in_sale) {
                ...
                $this->order_price += $product->sale_price > 0 ? $product->sale_price : $product->regular_price;

            } else {

                $this->order_price += $product->regular_price;
            }
